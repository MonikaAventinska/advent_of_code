...
for vstup in vstupy:
    ...
    if abs(x0 - x1) == abs(y0 - y1):
        ...
        if x0 < x1:
            ...
            if y0 < y1:
                for e, x in enumerate(range(x0, x1 + 1), 1):
                    vystupy.append(str([x, y0 + e - 1]))
            else:
                for e, x in enumerate(range(x0, x1 + 1), 1):
                    vystupy.append(str([x, y0 - e + 1]))
            ...
            if y0 < y1:
                for e, x in enumerate(range(x0, x1 - 1, -1), 1):
                    vystupy.append(str([x, y0 + e - 1]))
            else:
                for e, x in enumerate(range(x0, x1 - 1, -1), 1):
                    vystupy.append(str([x, y0 - e + 1]))
