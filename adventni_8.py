vstupy = {'bgcfda gecbda abdgf aedfbg eda efcbd ae agfe bdefagc fbeda' : 'ae egdafb ea fcdeb',
...
"""
hodnoty = list(vstupy.values())
pocitadlo = 0
for hodnota in hodnoty:
    str(hodnota)
    davam_carky = hodnota.split( )
    for kod in davam_carky:
        if len(kod) == 2 or len(kod) == 3 or len(kod) == 4 or len(kod) == 7:
            pocitadlo += 1
print(pocitadlo)
"""
...
for hodnota in hodnoty:
    ...
    for kod in davam_carky:
        if len(kod) == 2:
            ...
            cislo = 8
        elif kod == 'gcdfa' or kod == 'cdgba':
            cislo = 2
        elif kod == 'fbcad' or kod == 'fcadb' or kod == 'cdbaf' or kod == 'cefdb' or kod == 'fcadb' or kod == 'cedba' or kod == 'bfgea':
            cislo = 3
        elif kod == 'cdfbe' or kod == 'cdfeb' or kod == 'dcbef' or kod == 'cbgef' or kod == 'bagce':
            cislo = 5
        elif kod == 'cdfgeb' or kod == 'gadfec' or kod == 'bcgafe':
            cislo = 6
        elif kod == 'cefabd' or kod == 'cefbgd' or kod == 'fcgedb' or kod == 'fdcagb' or kod == 'efabcd':
            cislo = 9
        elif kod == 'cagedb':
            cislo = 0
